...
-(void)setPort:(int)index1 in:(int)port1 and:(int)index2 in:(int)port2 and:(TouchView *)currentview{
    ...
    Line = [[CompositionLine alloc] initType:currentview.tag with:currentview.LineList.count object1:temp1 port1:port1 object2:temp2 port2:port2];
